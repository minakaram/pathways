...
document.addEventListener('DOMContentLoaded', () => {
    const dropdowns = {
        ...
        categories: document.querySelector('.categories-result'),
...
const categoriesResults = document.querySelector('.categories-result');
...
function hideAllResults() {
    [nameResults, yearsResults, durationsResults, citiesResults, categoriesResults, monthsResults].forEach(results => {
